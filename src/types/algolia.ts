...
export interface InternalSearchAlgoliaAttributes {
  title: Queries.MdxFrontmatter["title"];
  description: Queries.MdxFrontmatter["description"];
  publishedAt: Queries.MdxFrontmatter["publishedAt"];
  tags: Queries.MdxFrontmatter["tags"];
  imageUrl: string;
  headings: Heading[];
}
